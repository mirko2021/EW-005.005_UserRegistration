 ...
 * @version 1.0
 */
public class UserRegistrationSimulator {
	public static final Scanner scanner = new Scanner(System.in);
	public static final YatospaceDBConnectionPool connectionPool = YatospaceDBConnectionPool.getConnectionPool();
	public static final MySQLUserRegisterDAO dataSource = new MySQLUserRegisterDAO(connectionPool); 
	public static final MySQLCredentialsDAO parametersSource = new MySQLCredentialsDAO(connectionPool);
	public static final MySQLRegistrationController controller = new MySQLRegistrationController(dataSource, parametersSource);
	...
	public static void add() {
		...
		do {
			...
			if(controll.setGoodUsername(username).length()>0) {
				usernameOK=true;
	...
	public static void updateUsername() {
		...
		do {
			...
			if(controll.setGoodUsername(newUsername).trim().length()!=0) {
				usernameOK = true;
				controll.setUser(new User(username));
			}
		}while(!usernameOK); 
