...
/**
 * Контролер за баратање регистрима за кориснике. 
 * @author MV
 * @version 1.0
 */
public class MySQLRegistrationController implements UserDataManervar{
	private MySQLCredentialsController engine; 
	private String checkingPasswordRecord; 

	public MySQLRegistrationController(MySQLUserRegisterDAO dataSource, MySQLCredentialsDAO parameterSoucre){
		if(dataSource==null) throw new NullPointerException();
		if(parameterSoucre==null) throw new NullPointerException();
		engine = new MySQLCredentialsController(dataSource, parameterSoucre);
	}
	...
	@Override
	public MySQLRegistrationController setCheckPassportRecord(String passport) {
	...
	@Override
	public MySQLCredentialsController getDataSource() {
		return engine;
	}
